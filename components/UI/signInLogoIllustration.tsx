...
import peopleThought from "@/assets/logo/peopleThought.png";

export default function SignInLogoIllustration() {
  return (
    <div className="relative flex items-center justify-center py-10 lg:py-0">
      ...
      <Image
        src={peopleThought}
        alt="ChatIcon"
        className="drop-shadow-[0_0_40px_rgba(139,92,246,0.5)] h-80 w-80"
      />
      {/* <ChatBubbleIcon/> */}
    </div>
  );
